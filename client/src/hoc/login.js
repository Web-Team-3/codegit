    ...
    return (
      <div  className="w-72 h-72 bg-white rounded-lg">
        <form className="flex flex-col items-center pt-10">
          ...
          <input type="submit" value="Login" className="w-20 h-10 bg-gray-200 rounded-md shadow-xl text-black hover:bg-black hover:text-white transition-colors duration-500 ease-out"></input>
        </form>
      </div>
    );
}